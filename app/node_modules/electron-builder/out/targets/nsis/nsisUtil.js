...
class AppPackageHelper {
    ...
    packArch(arch, target) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (infoPromise == null) {
                infoPromise = (0, (_builderUtil || _load_builderUtil()).subTask)(`Packaging NSIS installer for arch ${(_builderUtil || _load_builderUtil()).Arch[arch]}`, target.buildAppPackage(target.archs.get(arch), arch));
