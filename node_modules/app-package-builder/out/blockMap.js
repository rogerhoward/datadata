...
let createDifferentialPackage = exports.createDifferentialPackage = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (archiveFile) {
        ...
        try {
            ...
            const blockMap = yield computeBlockMap(sevenZFile, "lzma", process.env.ELECTRON_BUILDER_COMPRESSION_LEVEL || "9");
            sevenZFile.close();
...
let computeBlockMap = exports.computeBlockMap = (() => {
    var _ref4 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (sevenZFile, compressionMethod, compressionLevel) {
        ...
        const files = archive.files.filter(function (it) {
    ...
    return function computeBlockMap(_x6, _x7, _x8) {
