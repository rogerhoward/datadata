...
class Packager {
    ...
    constructor(options, cancellationToken) {
        ...
        try {
            (0, (_builderUtil || _load_builderUtil()).log)("electron-builder " + "19.30.1");
        } catch (e) {
    ...
    build() {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            } else if (configFromOptions != null && configFromOptions.extends != null && configFromOptions.extends.indexOf(".") !== -1) {
    ...
    doBuild(outDir) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            for (const _ref2 of _this3.options.targets) {
                var _ref3 = _slicedToArray(_ref2, 2);

                const platform = _ref3[0];
                const archToType = _ref3[1];
                ...
                for (const _ref4 of (0, (_targetFactory || _load_targetFactory()).computeArchToTargetNamesMap)(archToType, packager.platformSpecificBuildOptions, platform)) {
                    var _ref5 = _slicedToArray(_ref4, 2);

                    const arch = _ref5[0];
                    const targetNames = _ref5[1];
