...
function _load_asarUtil() {
    return _asarUtil = require("./util/asarUtil");
}
...
class PlatformPackager {
    ...
    copyAppFiles(taskManager, asarOptions, resourcePath, outDir, platformSpecificBuildOptions, excludePatterns, macroExpander) {
        ...
        const _computeFileSets = matchers => {
            return (0, (_AppFileCopierHelper || _load_AppFileCopierHelper()).computeFileSets)(matchers, transformer, this.info, isElectronCompile);
        };
    ...
    computeSafeArtifactName(suggestedName, ext, arch) {
        let skipArchIfX64 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    ...
    expandArtifactNamePattern(targetSpecificOptions, ext, arch, defaultPattern) {
        let skipArchIfX64 = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
    ...
    expandMacro(pattern, arch) {
        ...
        let isProductNameSanitized = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
